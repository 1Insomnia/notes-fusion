  ...
  return (
    <li className="p-5 rounded-lg border border-border bg-card-background text-card-foreground shadow-sm flex justify-between items-center py-3 px-5 cursor-pointer">
      ...
      <div className="h-full flex">
        ...
        <NavLink
          to={`/notes/${id}/edit`}
          className="w-16 h-16 text-warning hover:text-warning/90 flex items-center justify-center"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
        ...
        <button
          ...
          className="w-16 h-16 text-error hover:text-error/90  flex items-center justify-center"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
